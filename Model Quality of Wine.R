...
# -- TASK 3: FIND OUT MISSING VALUES(IF ANY) -- #
    ...
    # -- i) Display attributes wise number of missing value -- #
...
str(redwine$qualiy)
  ...
  # -- Step 3: Change class of Predicted variable from numeric to factor -- #
      # -- (Logistic regression perform only when Predicted variable is categorical data) -- #

redwine$qualiy <- as.factor(redwine$qualiy)
str(redwine)

  # -- Step 4: Using R Formula, no need to write var. names -- # 
